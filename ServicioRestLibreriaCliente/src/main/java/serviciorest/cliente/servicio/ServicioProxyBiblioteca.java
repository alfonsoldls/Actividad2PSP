...
public class ServicioProxyBiblioteca {
	...
	public Libro obtener(int id){
		try {
			...
			if(hs == HttpStatus.OK) {	
				//Si el libro existe, viene en formato JSON en el body
	...
	public Libro alta(Libro l){
		try {
			...
			//El segundo, parametros del libro que iran en el body
			//El tercero, el objeto que esperamos que nos envie el servidor
